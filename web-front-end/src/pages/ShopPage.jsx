  ...
  return (
    <div className='ShopPage container-fluid ' style={{ paddingTop: "110px" }}>
      <div className="row  ">
        ...
        <div className="col m-auto text-center "><h3 className='text-secondary'>SHOP</h3></div>
        <div className="col m-auto "><p>Affchage de 1–20 sur 78 résultats</p></div>
        <div className="col">
          ...
          <div className="col-sm-2 ">
            <div className='card' style={{ marginTop: '24px' }} >
              <article className='card-group-item'>
                <header className='card-header px-5'><h6 class="card-title">Brands </h6></header>
